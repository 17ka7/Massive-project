        ...
        <div className=' bg-custom-white grid grid-flow-col p-14 gap-10 '>
            <div className='flex flex-col justify-center'>
                <form action="" className=' mb-16'>
                    ...
                    <input type="text" name="username" required className=' w-full outline-none bg-custom-white'/> 
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex border-2 border-custom-blue p-3 rounded-md'>
                    <input type="email" name="username" required  className='w-full bg-custom-white outline-none'/> 
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='flex border-2 border-custom-blue p-3 rounded-md'>
                    <input type="password" name="username" required className='w-full bg-custom-white outline-none'/>
                ...
                <div className='flex flex-row gap-5 w-full'>
                    ...
                    <button className='  text-custom-white bg-custom-blue rounded-lg font-bold py-3 px-10 text-[20px]'>Simpan</button>
                </div>
            </div>
            <div className='flex flex-col'>
